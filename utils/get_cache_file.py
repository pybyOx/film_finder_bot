...
def get_cache_file(file_path: str, period: int, func_for_create_data: Callable,
...
def get_genres() -> dict:
    ...
    return get_cache_file(GENRES_CACHE_FILE, 7, make_api_request, write_genres_data,
...
def get_movie_of_day() -> dict:
    ...
    params = {**BASE_PARAMS,
              ...
              "page": 1}
    movie = get_cache_file(MOVIE_OF_DAY_CACHE, 1, random_movie, None, params, 1)
    return movie
